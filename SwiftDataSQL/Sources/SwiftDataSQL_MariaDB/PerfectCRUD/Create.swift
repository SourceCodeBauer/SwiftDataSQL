...
public struct ForeignKeyActionIgnore: ForeignKeyActionProvider {
    static nonisolated(unsafe) public var action = ForeignKeyAction.ignore
}

public struct ForeignKeyActionRestrict: ForeignKeyActionProvider {
    static nonisolated(unsafe) public var action = ForeignKeyAction.restrict
}

public struct ForeignKeyActionSetNull: ForeignKeyActionProvider {
    static nonisolated(unsafe) public var action = ForeignKeyAction.setNull
}

public struct ForeignKeyActionSetDefault: ForeignKeyActionProvider {
    static nonisolated(unsafe) public var action = ForeignKeyAction.setDefault
}

public struct ForeignKeyActionCascade: ForeignKeyActionProvider {
    static nonisolated(unsafe) public var action = ForeignKeyAction.cascade
}

nonisolated(unsafe) public let ignore = ForeignKeyActionIgnore()
nonisolated(unsafe) public let restrict = ForeignKeyActionRestrict()
nonisolated(unsafe) public let setNull = ForeignKeyActionSetNull()
nonisolated(unsafe) public let setDefault = ForeignKeyActionSetDefault()
nonisolated(unsafe) public let cascade = ForeignKeyActionCascade()
